...
- Metadata edit UX is now available across Sets, Classes, and Tribes: click a
  table row to open an edit modal, validate with the same schema, cancel/save,
  and show update toasts. The shared modal lives in
  `src/common/EditRecordModal.tsx`.
